...
#                    self.split_folders[pjoin(cwd,subfolder)] = [exe] + args
    ...
    def compile(self, mode, options):
        ...
        # NOTE!
        # The following lines were commented out according to HC_NLO_X0_UFO
        # model guide: http://feynrules.irmp.ucl.ac.be/attachment/wiki/HiggsCharacterisation/README
