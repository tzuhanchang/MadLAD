...
### Added
 - Add `gen.block_madspin.misc` setting in configuration ([#82](https://github.com/tzuhanchang/MadLAD/pull/82))
 - Add `ssWWjj_nlo-vlvl` and `ssWWjj_lo-vlvl` processes ([#81](https://github.com/tzuhanchang/MadLAD/pull/81))
